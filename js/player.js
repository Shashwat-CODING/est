...
// Set kavin.rocks as the default Piped instance
const DEFAULT_INSTANCE = 'https://pipedapi.kavin.rocks';
	...
	.then(data => {
		for (const instance of data) {
			pipedInstances.add(new Option(
				instance, instance, '',
				instance === DEFAULT_INSTANCE || getSaved('pipedInstance') === instance
			));
		}
		// If no instance is saved, set kavin.rocks as default
		if (!getSaved('pipedInstance')) {
			save('pipedInstance', DEFAULT_INSTANCE);
		}
	})
	.catch(err => {
